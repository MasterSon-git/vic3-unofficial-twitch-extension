...
const openapi = new OpenAPI({
  ...
  servers: [{ url: "https://vic3-unofficial-twitch-ebs.masterharz-ss.workers.dev" }],
});
...
app.post(
  ...
  openapi.operation({
    ...
    responses: {
      200: { description: "Pairing initialized successfully" },
      400: { description: "Missing or invalid channelId" },
      401: { description: "Invalid Twitch JWT" },
      403: { description: "Streamer cap reached or forbidden" },
    },
  }),
  async (c) => {
...
app.post(
  ...
  openapi.operation({
    ...
    responses: {
      200: { description: "Pairing completed successfully" },
      400: { description: "Missing or invalid pairing code" },
    },
  }),
  async (c) => {
...
app.post(
  "/ingest",
  openapi.operation({
    summary: "Ingest snapshot",
    requestBody: SnapshotSchema,
    responses: {
      200: { description: "Snapshot ingested successfully" },
      400: { description: "Invalid snapshot" },
      409: { description: "Stale sequence or needs new autosave" },
      429: { description: "Too soon since last ingest" },
      413: { description: "Payload too large" },
      502: { description: "PubSub broadcast failed" },
    },
  }),
  zValidator("json", SnapshotSchema),
  async (c) => {
...
app.put(
  "/bootstrap",
  openapi.operation({
    summary: "Upload bootstrap",
    requestBody: BootstrapSchema,
    responses: {
      204: { description: "Bootstrap uploaded successfully" },
      400: { description: "Invalid bootstrap" },
    },
  }),
...
app.get(
  "/bootstrap/:channelId",
  openapi.operation({
    summary: "Get bootstrap for a channel",
    parameters: [
      {
        name: "channelId",
        in: "path",
    ...
    responses: {
      ...
      404: { description: "Bootstrap not found" },
    },
  }),
  async (c) => {
